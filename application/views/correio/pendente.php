...
<?php
  if ($obj) {
      ...
      echo '<button type="button" onClick="confirmarCorreio()" value="'.$linha->correio_id_correio.'" class="glyphicon glyphicon-ok btn btn-success btn-xs confirmarCorr"></button>';
    	echo "</td>";
      echo "</tr>";
    }
  }
